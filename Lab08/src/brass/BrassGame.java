...
public class BrassGame implements Drawable
{
	...
	//DO THIS
	//add required declarations and methods for BrassBuildActionState
	...
	{
		this();
		//num_players will not be used until much later
   ...
   public BrassGame()
   {
	...
	public void buildIndustry(int city_id, int industry_id, int player_id)
	{
		...
		//city must have room for the industry
		//player must have enough money
		//player cannot already have a token during canal phase
