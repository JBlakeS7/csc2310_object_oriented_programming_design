...
class BrassCottonDemandTrack
{
	...
	{
		//a tile is flipped and the marker is adjusted on the track
		//the -1 indicates the sale is refused as the marker made it to the bottom of the track
		if (!adjustCottonTrack()) return -1;
		
		//DO THIS
		//compute the extra income according to the new marker location
