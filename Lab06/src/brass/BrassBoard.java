...
class BrassBoard
{
	...
	private BrassCanals brass_canals;
	private BrassRails brass_rails;
	...
	{
		brass_connections.constructLink(link_id, player_id);
	...
	public int getSelectedLink(int x, int y)
	{
		...
		/*
		if(rail_phase)
			return brass_rails.getSelectedLink(x, y);
	...
	{
		if(change_phase.isSelected(x, y) && !rail_phase)
		{
			rail_phase = true;
			return true;
		}
