...
/** 
	Generates a permutation of r integers selected from n integers (1...n) 
...
public class RandomPermutation implements Permutation
{
   ...
   public int next()
   {
	  ...
	  Random rand_gen = Random.getRandomNumberGenerator();
      int rand = rand_gen.randomInt(1, numbers.size());
